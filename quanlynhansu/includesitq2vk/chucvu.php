...
function pb_display(x,y)       
   {
   ajaxLoad('displaytkchucvuctn.php?lich='+x,'lichps');
   }
</script>
...
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b>Tìm Nhân viên theo Chức vụ</b></td></tr>
<tr><td height='10'><img src='images/line2copy.png' border='0' width='450' height='1'></td></tr>
<tr><td height='10'></td></tr>    
		<tr> 
      	<td><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'> Tên Chức vụ :</b></font>
        <select name="title" id="title" onchange="pb_display(this.value);">
<?php $a="select * from qlns_chucvu ";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><option value='<?=$row['qlns_macv']?>'><?php echo $row['qlns_tenchucvu']; ?></option>
<? }?> 
</select></td>
    	</tr>
   <tr><td><div id="lichps">
