...
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b> Danh sách nhân viên theo Phòng ban</b></td></tr>
...
#################################################
	...
	$sql=@mysql_query("select * from qlns_hosonhanvien where qlns_mabp ='$get' order by qlns_hsnv desc");
   ...
   if($number_page>=1){   
     	$listpage="<div align='right'><img src='../images/nghanhnghe.png' height='15' width='15' border='0' alt='S&#7889; trang | Total page'> <span class='designwfdsafsdff'><b>Trang:</b>"; 
    	    ...
    	    $listpage.="<a href='displaytkdonvictn.php?page=$i' size='2'> $i</a>" ;
