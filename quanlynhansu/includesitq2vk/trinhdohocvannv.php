...
#################################################
 ...
 $sqlrow=@mysql_query("select * from qlns_trinhdohv where qlns_mahsnv=$id");
 $rowhd=@mysql_fetch_assoc($sqlrow);
    $vinh=@mysql_num_rows($sqlrow);
    if($vinh){
    	$qlns_trinhdohv=$rowhd['qlns_trinhdohv'];
    echo "<tr><td valign='top'><div align='center'>
    <table border='0' width='90%' name='fadfdsddsrw' cellSpacing='0' cellPadding='0'>
    <tr><td width='25%' valign='top'><div align='left'><span class='tinhyeuhue'>Trình độ :</span></td><td width='5'></td><td width='70%' valign='top'><div align='left' ><span class='tinhyeuhueit'>$qlns_trinhdohv </span></td></tr>
    </table></td></tr>";}
    else {
    	echo "<tr><td valign='top'><div align='center'>
