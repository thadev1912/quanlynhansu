...
<table border='0' width='254' name='vigfdsggfds'  cellSpacing=0 cellPadding=0>
	...
	<tr><td background='images/nhansu_10.png' width='71' height='23'></td>
		...
		<tr><td valign='top'>
			...
			<tr><td background='images/giaodientimkiemcmnd.png' width='36' height='25'></td><td background='images/giaodientimkiem_33.png' width='126' height='25'><form action="kqsearchctncmnd.php" method='POST' name='fsdarfe4'><input name="searchword" class="inputboxdesignwebvn" alt="Chứng minh nhân dân"  value="Chứng minh nhân dân" onblur="if(this.value=='') this.value='Chứng minh nhân dân';" onfocus="if(this.value=='Chứng minh nhân dân') this.value='';" type="text"></td><td background='images/giaodientimkiem_34.png' width='67' height='25'><input src="images/timkiem1.png" onmouseover="this.src='images/tinhkiem2.png'" onmouseout="this.src='images/timkiem1.png'" type="image"></td></tr> </form>
			</table></td></tr>
...
?>
			...
			<?php 
			   $search=intval($_POST['searchword']);
			   $keyword=intval($_GET['keyword']);	
			   if($keyword == Null){
			   $page=intval($_GET["page"]);
			   if($page=="") $page="1";
			   $sqlvinh=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_macmnd ='$search' order by qlns_hsnv desc");
			   $totalrow=@mysql_num_rows($sqlvinh);
			   $rowperpage=12; 
			   $max_page=ceil($totalrow/$rowperpage);
			   $start=($page-1)* $rowperpage;
			   $sqlgioihan=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_macmnd ='$search' order by qlns_hsnv desc limit $start,$rowperpage");
		    ...
		    <tr>
			<td width='75' height='27'><div align='center'><a href='detailnvsearchcmnd.php?ctnvietnam=<?php echo $mahsnv; ?>&&keyword=<?php echo $search; ?>' class='tinhyeuhueemyeu'><?php echo   $qlns_manv; ?></a></td>
			<td width='93' height='27'><div align='left'><a href='detailnvsearchcmnd.php?ctnvietnam=<?php echo $mahsnv; ?>&&keyword=<?php echo $search; ?>' class='tinhyeuhueemyeu'><?php echo $honv ." ".$tennv; ?></a></td>
			<td width='61' height='27'><div align='left'><span class='tinhyeuhueemye'>
				<table border='0' width='61' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0><tr><td width='3'></td>
						<td width='58'><div align='left'><a href='detailnvsearchcmnd.php?ctnvietnam=<?php echo $mahsnv; ?>&&keyword=<?php echo $search; ?>' class='tinhyeuhueemyeu'><?php  
            ...
            if($page>1){
 echo  "<TD class=pagemenu><div align='right'><A HREF=\"kqsearchctncmnd.php?page=$i&&keyword=$search\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD><td widht='2'></td>";
 $page=$page-1;
  echo "<TD class=pagemenu><b><A HREF=\"kqsearchctncmnd.php?page=$page&&keyword=$search\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD><td widht='2'></td>";
  }
for($i;$i<=$max; $i++) {
...
if ($i==$page) {
        ...
        echo "<TD class=pagemenu><div align='right'>&nbsp;<A HREF=\"kqsearchctncmnd.php?page=$i&&keyword=$search\" class=song title=\"Trang $i\"><font size=1><b>$i</b></font></A>&nbsp;</TD><td widht='2'></td>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=pagemenu><div align='right'><b><A HREF=\"kqsearchctncmnd.php?page=$page&&keyword=$search\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD><td widht='2'></td>"; 
	 echo "<TD class=pagemenu><div align='right'><A HREF=\"kqsearchctncmnd.php?page=$max_page&&keyword=$search\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
			   ...
			   $page=intval($_GET["page"]);
			   if($page=="") $page="1";
			   $sqlvinh=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_macmnd ='$keyword' order by qlns_hsnv desc");
			   $totalrow=@mysql_num_rows($sqlvinh);
			   $rowperpage=12;
			   $max_page=ceil($totalrow/$rowperpage);
			   $start=($page-1)* $rowperpage;
			   $sqlgioihan=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_macmnd = '$keyword' order by qlns_hsnv desc limit $start,$rowperpage");
		       while($vinh=@mysql_fetch_assoc($sqlgioihan)){
		       	     $qlns_manv=$vinh["qlns_manv"];
		       	     $mahsnv=$vinh["qlns_mahsnv"];
		       	     $honv=$vinh["qlns_honv"];
		     ...
		     <tr><td height='27'><ul class="pane-list"><li>
		   	<table border='0' width='99%' name='vfdfasafffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0>  			
		    <tr>
			<td width='75' height='27'><div align='center'><a href='detailnvsearchcmnd.php?ctnvietnam=<?php echo $mahsnv; ?>&&keyword=<?php echo $keyword; ?>' class='tinhyeuhueemyeu'><?php echo   $qlns_manv; ?></a></td>
			<td width='93' height='27'><div align='left'><a href='detailnvsearchcmnd.php?ctnvietnam=<?php echo $mahsnv; ?>&&keyword=<?php echo $keyword; ?>' class='tinhyeuhueemyeu'><?php echo $honv ." ".$tennv; ?></a></td>
			<td width='61' height='27'><div align='left'><span class='tinhyeuhueemye'>
				<table border='0' width='61' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0><tr><td width='3'></td>
						<td width='58'><div align='left'><a href='detailnvsearchcmnd.php?ctnvietnam=<?php echo $mahsnv; ?>&&keyword=<?php echo $keyword; ?>' class='tinhyeuhueemyeu'><?php  
						 $sqlvinhit=@mysql_query("select qlns_tenchucvu from qlns_chucvu where qlns_macv='$macv'");	
						 $rowv=@mysql_fetch_assoc($sqlvinhit);
						    $vhf=$rowv["qlns_tenchucvu"];
						    echo $vhf;	
            ...
            if($page>1){
 echo  "<TD class=pagemenu><div align='right'><A HREF=\"kqsearchctncmnd.php?page=$i&&keyword=$keyword\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD><td widht='2'></td>";
 $page=$page-1;
  echo "<TD class=pagemenu><b><A HREF=\"kqsearchctncmnd.php?page=$page&&keyword=$keyword\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD><td widht='2'></td>";
  }
for($i;$i<=$max; $i++) {
$page=$_GET['page']; if($page==""){$page=1;}
if ($i==$page) {
        ...
        echo "<TD class=pagemenu><div align='right'>&nbsp;<A HREF=\"kqsearchctncmnd.php?page=$i&&keyword=$keyword\" class=song title=\"Trang $i\"><font size=1><b>$i</b></font></A>&nbsp;</TD><td widht='2'></td>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=pagemenu><div align='right'><b><A HREF=\"kqsearchctncmnd.php?page=$page&&keyword=$keyword\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD><td widht='2'></td>"; 
	 echo "<TD class=pagemenu><div align='right'><A HREF=\"kqsearchctncmnd.php?page=$max_page&&keyword=$keyword\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
