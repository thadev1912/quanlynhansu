		...
		<td background='images/nhansu_11.png' width='169' height='23'><div align='center'>
            ...
            <option value="100" width='169'>-- CTN Vi&#7879;t Nam--</option>
               <?php 
         	   ...
         	   ?>
         	   <option value="<?php echo $qlns_mabp; ?>"> <? echo $qlns_tenbophan;?>
...
?></select>
	...
	<td background='images/giaodientimkiem_41.png' width='67' height='28'>
	 <select name="select" id="ngay"  class='quangvinhit' onchange="doShowCalendar();" size="1" style="width: 66px; height:19px">
		    ...
		    <tr>
			<td width='75' height='27'><div align='center'><a href='detailnvpgd.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php echo   $qlns_manv; ?></a></td>
			<td width='93' height='27'><div align='left'><a href='detailnvpgd.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php echo $honv ." ".$tennv; ?></a></td>
			<td width='61' height='27'><div align='left'><span class='tinhyeuhueemye'>
				<table border='0' width='61' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0><tr><td width='3'></td>
						<td width='58'><div align='left'><a href='detailnvpgd.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php  
 ...
 $page=$page-1;
  echo "<TD class=pagemenu><b><A HREF=\"detailnvpgd.php?page=$page&&bophan=$bophan\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD><td widht='2'></td>";
  }
for($i;$i<=$max; $i++) {
...
if ($i==$page) {
        ...
        echo "<TD class=pagemenu><div align='right'>&nbsp;<A HREF=\"detailnvpgd.php?page=$i&&bophan=$bophan\" class=song title=\"Trang $i\"><font size=1><b>$i</b></font></A>&nbsp;</TD><td widht='2'></td>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=pagemenu><div align='right'><b><A HREF=\"detailnvpgd.php?page=$page&&bophan=$bophan\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD><td widht='2'></td>"; 
	 echo "<TD class=pagemenu><div align='right'><A HREF=\"detailnvpgd.php?page=$max_page&&bophan=$bophan\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
