...
#################################################
 ...
 $sqlrow=@mysql_query("select * from qlns_khenthuongkl where qlns_mahsnv=$id");
 $rowhd=@mysql_fetch_assoc($sqlrow);
    $vinh=@mysql_num_rows($sqlrow);
    if($vinh){
    	$qlns_hinhthuc=$rowhd['qlns_hinhthuc'];
    	$qlns_lydo=$rowhd['qlns_lydo'];
    	$qlns_ngay=$rowhd['qlns_ngay'];
    echo "<tr><td valign='top'><div align='center'>
    <table border='0' width='90%' name='fadfdsddsrw' cellSpacing='0' cellPadding='0'>
     <tr><td width='25%' height='30'><div align='left'><span class='tinhyeuhue'>Ngày khen thưởng :</span></td><td width='5'></td><td width='70%'><div align='left'><span class='tinhyeuhueit'>$qlns_ngay </span></td></tr> 
     <tr><td width='25%' valign='top'><div align='left'><span class='tinhyeuhue'>Hình thức :</span></td><td width='5'></td><td width='70%' valign='top'><div align='left' ><span class='tinhyeuhueit'>$qlns_hinhthuc </span></td></tr>
     <tr><td width='25%' valign='top'><div align='left'><span class='tinhyeuhue'>Lý do :</span></td><td width='5'></td><td width='70%' valign='top'><div align='left'><span class='tinhyeuhueit'>$qlns_lydo </span></td></tr> 
