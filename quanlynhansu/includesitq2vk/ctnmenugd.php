...
function pb_display(x,y)       
   {
   ajaxLoad('displaychucvu.php?lich='+x,'lichps');
   }
 function pb_display1(y,z)       
   {
   ajaxLoad1('displaychucvu.php?lich='+y,'lichps');
   }
function pb_display2(z,y)       
   {
   ajaxLoad2('displaychucvu.php?ngay='+z,'lichps');
   }
  function doShowCalendar()
{
	...
	if(ngay != '' && kenh != ''){
		ajaxLoad('displaychucvu.php?ngay='+ngay+'&kenh='+kenh,'lichps');
	}else{
	...
	<tr><td background='images/nhansu_10.png' width='71' height='23'></td>
		<td background='images/nhansu_11.png' width='169' height='23'><div align='center'>
            ...
            <option value="100" width='169'>-- CTN Vi&#7879;t Nam--</option>
               <?php 
                     $sqlink=@mysql_query("select * from qlns_bophan");
         	         while ($rowlink=@mysql_fetch_assoc($sqlink)){ 
         	         	    $qlns_tenbophan=$rowlink["qlns_tenbophan"];
         	         	    $qlns_mabp=$rowlink["qlns_mabp"];	 
         	   ?>
         	   <option value="<?php echo $qlns_mabp; ?>" <?php if($qlns_mabp==$bophan){echo "selected";}?>> <? echo $qlns_tenbophan;?>
		...
		<tr><td valign='top'>
			...
			<select name="select" id="kenh" class='quangvinhit' onchange="doShowCalendar();"  size="1" style="width: 80px; height:19px">	
				<?php
...
?></select>
			</td><td background='images/giaodientimkiemchucvu.png' width='46' height='28'></td>
	<td background='images/giaodientimkiem_41.png' width='67' height='28'>
	 <select name="select" id="ngay"  class='quangvinhit' onchange="doShowCalendar();" size="1" style="width: 66px; height:19px">
                   <?php 
                   	$query_tinh1=@mysql_query("select * from qlns_chucvu ORDER BY qlns_idcv ASC");
                     while($row_tinh1=@mysql_fetch_array($query_tinh1))
                     {
                     $qlns_tenbophan1=$row_tinh1["qlns_tenchucvu"];
         	         $qlns_macv1=$row_tinh1["qlns_macv"];
         	     ?>    	  	 
                  <option value="<?php echo $qlns_macv1; ?>" <?php if($qlns_macv1==$bophan){echo "selected";}?>> <? echo $qlns_tenbophan1;?>
                  <?php    }
                   ?>
                   </select> 
	</td></tr> 
			...
			<?php 
			  ...
			  echo "<table border='0' width='229' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0>";	  
			   ...
			   if($page=="") $page="1";
			   $sqlvinh=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_macv='$bophan' order by qlns_hsnv desc");
			   $totalrow=@mysql_num_rows($sqlvinh);
			   $rowperpage=15;
			   $max_page=ceil($totalrow/$rowperpage);
			   $start=($page-1)* $rowperpage;
			   $sqlgioihan=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_macv='$bophan' order by qlns_hsnv desc limit $start,$rowperpage");
		    ...
		    <tr>
			<td width='75' height='27'><div align='center'><a href='detailnvgd.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php echo   $qlns_manv; ?></a></td>
			<td width='93' height='27'><div align='left'><a href='detailnvgd.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php echo $honv ." ".$tennv; ?></a></td>
			<td width='61' height='27'><div align='left'><span class='tinhyeuhueemye'>
				<table border='0' width='61' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0><tr><td width='3'></td>
						<td width='58'><div align='left'><a href='detailnvgd.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php  
 ...
 $page=$page-1;
  echo "<TD class=pagemenu><b><A HREF=\"detailnvgd.php?page=$page&&bophan=$bophan\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD><td widht='2'></td>";
  }
for($i;$i<=$max; $i++) {
...
if ($i==$page) {
        ...
        echo "<TD class=pagemenu><div align='right'>&nbsp;<A HREF=\"detailnvgd.php?page=$i&&bophan=$bophan\" class=song title=\"Trang $i\"><font size=1><b>$i</b></font></A>&nbsp;</TD><td widht='2'></td>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=pagemenu><div align='right'><b><A HREF=\"detailnvgd.php?page=$page&&bophan=$bophan\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD><td widht='2'></td>"; 
	 echo "<TD class=pagemenu><div align='right'><A HREF=\"detailnvgd.php?page=$max_page&&bophan=$bophan\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
