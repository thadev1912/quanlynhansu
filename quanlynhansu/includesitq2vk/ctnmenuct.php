	...
	<td background='images/giaodientimkiem_41.png' width='67' height='28'>
	 <select name="select" id="ngay"  class='quangvinhit' onchange="doShowCalendar();" size="1" style="width: 66px; height:19px">
                   ...
                   while($row_tinh1=@mysql_fetch_array($query_tinh1))
                     {
                 echo "<option value=$row_tinh1[qlns_mabp]>$row_tinh1[qlns_tenbophan]</option>" ;
                      }
                   ?>
                   </select> 
	</td></tr> 
			...
			<?php 
			  ...
			  echo "<table border='0' width='229' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0>";	  
			   ...
			   if($page=="") $page="1";
			   $sqlvinh=@mysql_query("select qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_mabp='$bophan' order by qlns_hsnv desc");
			   $totalrow=@mysql_num_rows($sqlvinh);
			   $rowperpage=15;
			   $max_page=ceil($totalrow/$rowperpage);
			   $start=($page-1)* $rowperpage;
			   $sqlgioihan=@mysql_query("select qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_mabp='$bophan' order by qlns_hsnv desc limit $start,$rowperpage");
		    ...
		    <tr>
			<td width='75' height='27'><div align='center'><a href='detailnvxu.php?ctnvietnam=<?php echo $mahsnv; ?>&&bophan=<?php echo $bophan; ?>' class='tinhyeuhueemyeu'><?php echo   $mahsnv; ?></a></td>
