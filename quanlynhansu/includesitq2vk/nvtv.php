...
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b> Danh sách nhân viên thử việc</b></td></tr>
...
#################################################
	...
	$sql=@mysql_query("select * from qlns_hosonhanvien where qlns_tinhtrangnv='0' order by qlns_hsnv desc");
