...
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b> Danh sách Khen thưởng, bị kỷ luật</b></td></tr>
...
#################################################
	...
	$sql=@mysql_query("select * from qlns_hosonhanvien,qlns_khenthuongkl where qlns_hosonhanvien.qlns_mahsnv=qlns_khenthuongkl.qlns_mahsnv order by qlns_hsnv desc");
   ...
   if($number_page>=1){   
     	$listpage="<div align='right'><img src='../images/nghanhnghe.png' height='15' width='15' border='0' alt='S&#7889; trang | Total page'> <span class='designwfdsafsdff'><b>Trang:</b>"; 
    	    ...
    	    $listpage.="<a href='cbcc.php?page=$i' size='2'> $i</a>" ;
...
<?php        
    ...
    echo "<tr><td valign='top'><div align='center'> <span class='designwebdnitq2'>Dữ Liệu đang cập nhật</span> </p></td></tr>"; }
