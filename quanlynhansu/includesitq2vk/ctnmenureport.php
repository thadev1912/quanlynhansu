...
function pb_display(x,y)       
   {
   ajaxLoad('displaybaocao.php?lich='+x,'lichps');
   }
</script>
...
<table border='0' width='254' name='vigfdsggfds'  cellSpacing=0 cellPadding=0>
	...
	<tr><td background='images/baocao.png' width='71' height='23'></td>
		<td background='images/nhansu_11.png' width='169' height='23'><div align='center'>
            ...
            <option value="100" selected="selected" width='169'>-- CTN Vi&#7879;t Nam--</option>
         	   ...
         	   <option value="50">Cán bộ chủ chốt</option>
         	   <option value="1">Nhân viên Nam</option>
         	   <option value="0">Nhân viên Nữ</option>	   	
            </select>
	...
	<tr><td>
			...
			<?php 
		      ...
		      $page="1";
			   $sqlvinh=@mysqli_query($conn,"select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_tinhtrangnv = 1 order by qlns_hsnv desc");
			   $totalrow=@mysqli_num_rows($sqlvinh);
			   $rowperpage=15;
			   $max_page=ceil($totalrow/$rowperpage);
			   $start=($page-1)* $rowperpage;
			   $sqlgioihan=@mysqli_query($conn,"select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_tinhtrangnv = 1 order by qlns_hsnv desc limit $start,$rowperpage");
		    ...
		    <tr>
			<td width='75' height='27'><div align='center'><a href='detailnvreport.php?ctnvietnam=<?php echo $mahsnv; ?>' class='tinhyeuhueemyeu'><?php echo   $qlns_manv; ?></a></td>
			<td width='93' height='27'><div align='left'><a href='detailnvreport.php?ctnvietnam=<?php echo $mahsnv; ?>' class='tinhyeuhueemyeu'><?php echo $honv ." ".$tennv; ?></a></td>
			<td width='61' height='27'><div align='left'><span class='tinhyeuhueemye'>
				<table border='0' width='61' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0><tr><td width='3'></td>
						<td width='58'><div align='left'><a href='detailnvreport.php?ctnvietnam=<?php echo $mahsnv; ?>' class='tinhyeuhueemyeu'><?php  
				...
				<tr><td><span class='tinhyeuhueemyeit'>&nbsp;&nbsp;&nbsp;&nbsp; Tổng Cán bộ nhân viên : </span><td></tr>	
					</table>
            ...
            if($page>1){
 echo  "<TD class=pagemenu><div align='right'><A HREF=\"reportctn.php?page=$i\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD><td widht='2'></td>";
 $page=$page-1;
  echo "<TD class=pagemenu><b><A HREF=\"reportctn.php?page=$page\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD><td widht='2'></td>";
  }
for($i;$i<=$max; $i++) {
...
if ($i==$page) {
        ...
        echo "<TD class=pagemenu><div align='right'>&nbsp;<A HREF=\"reportctn.php?page=$i\" class=song title=\"Trang $i\"><font size=1><b>$i</b></font></A>&nbsp;</TD><td widht='2'></td>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=pagemenu><div align='right'><b><A HREF=\"reportctn.php?page=$page\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD><td widht='2'></td>"; 
	 echo "<TD class=pagemenu><div align='right'><A HREF=\"reportctn.php?page=$max_page\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
