...
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b> Danh sách nhân viên theo Chức vụ</b></td></tr>
...
#################################################
	...
	$sql=@mysql_query("select * from qlns_hosonhanvien where qlns_macv ='$get' order by qlns_hsnv desc");
