	...
	<tr><td background='images/nhansu_10.png' width='71' height='23'></td>
		<td background='images/nhansu_11.png' width='169' height='23'><div align='center'>
             ...
             <option value="24"><?php echo "Bộ Phận Xây Dựng"  ?></option>
                             ...
                             <option value="17" selected="selected"><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dự án Ngọc Hoàng Măng Bút"  ?></option>
       ...
       <option value="100"  width='169'>-- CTN Vi&#7879;t Nam--</option>
			...
			<?php 
			  ...
			  echo "<table border='0' width='229' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0>";	  
			   ...
			   if($page=="") $page="1";
			   $sqlvinh=@mysql_query("select qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_mabp='$bophan' and qlns_tinhtrangnv != 2 order by qlns_hsnv desc");
