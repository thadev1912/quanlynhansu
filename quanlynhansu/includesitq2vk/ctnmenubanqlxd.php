	...
	<tr><td background='images/nhansu_10.png' width='71' height='23'></td>
		<td background='images/nhansu_11.png' width='169' height='23'><div align='center'>
            ...
            <option value="100"  width='169'>-- CTN Vi&#7879;t Nam--</option>
             ...
             <option value="24" ><?php echo "Quản lý xây dựng"  ?></option>
                             <option value="19" selected="selected"><?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ban Quản lý xây dựng"  ?></option>
	 ...
	 <select name="select" id="ngay"  class='quangvinhit' onchange="doShowCalendar();" size="1" style="width: 66px; height:19px">
			...
			<?php 
			  ...
			  echo "<table border='0' width='229' name='vfdfasaffdgsdgsigfdsffggfds'  cellSpacing=0 cellPadding=0>";	  
			   ...
			   if($page=="") $page="1";
			   $sqlvinh=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_mabp='19' and qlns_tinhtrangnv != 2 order by qlns_hsnv desc");
			   $totalrow=@mysql_num_rows($sqlvinh);
			   $rowperpage=15;
			   $max_page=ceil($totalrow/$rowperpage);
			   $start=($page-1)* $rowperpage;
			   $sqlgioihan=@mysql_query("select qlns_manv,qlns_mahsnv,qlns_honv,qlns_tennv,qlns_macv from qlns_hosonhanvien where qlns_mabp='19' and qlns_tinhtrangnv != 2 order by qlns_hsnv desc limit $start,$rowperpage");
