	...
	<tr><td background='images/nhansu_10.png' width='71' height='23'></td>
		<td background='images/nhansu_11.png' width='169' height='23'><div align='center'>
            ...
            <option value="100"  width='169'>-- CTN Vi&#7879;t Nam--</option>
             ...
             <option value="24" selected="selected"><?php echo "Quản lý xây dựng"  ?></option>
...
if ($i==$page) {
	...
	$page=$page+1;
	 ...
	 echo "<TD class=pagemenu><div align='right'><A HREF=\"detailnvqlxd.php?page=$max_page&&bophan=$bophan\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
