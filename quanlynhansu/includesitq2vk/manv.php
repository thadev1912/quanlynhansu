...
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b> Kết quả tìm kiếm theo mã nhân viên</b></td></tr>
...
#################################################
	...
	$sql=@mysql_query("select * from qlns_hosonhanvien where qlns_mahsnv like '%$search%' order by qlns_hsnv desc");
...
<table border='0' width='98%' name='fadfdsrw' cellSpacing='0' cellPadding='0'>
<tr><td height='25'></td></tr>	
<tr><td valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='designwfdsaf'><b> Tìm theo mã nhân viên </b></td></tr>
<tr><td height='10'><img src='images/line2copy.png' border='0' width='450' height='1'></td></tr>
<tr><td height='10'></td></tr> 
<tr><td><form action="manv.php?search=timkiem" method='POST'><span class='designwfdsafsdff'> Nhập mã nhân viên :	</span> <input name="searchword" alt="search" class="inputbox" value="search..." onblur="if(this.value=='') this.value='search...';" onfocus="if(this.value=='search...') this.value='';" type="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input src="../images/timkiem1.png" onmouseover="this.src='../images/timkiem2.png'" onmouseout="this.src='../images/timkiem1.png'" type="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></form>
	</td></tr>
		</table>
	<?php }	?>
</body>
