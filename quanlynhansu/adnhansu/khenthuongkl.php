...
<meta http-equiv="REFRESH" content="2; url=khenthuongkl.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="khenthuongkl.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_khenthuongkl set
...
<script language="javascript">
	...
	{ var the_sotien    = the_form.sotien.value;
      if ((the_sotien==''))
		{
			alert("Bạn chưa nhập thông tin khen thưởng!");
...
<center>
<form action="khenthuongkl.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Khen Thưởng nhân viên </b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<input  name="sotien" type="text" id="sotien" size='90'>
	</td>
	</tr>   	
		<tr> 
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval($_GET["id"] );
    $a = "select * from qlns_khenthuongkl where qlns_idktkl= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=khenthuongkl.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"khenthuongkl.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $ghichu =$_POST["ghichu"];
    $sotien = $_POST['sotien'];
    $q3 = "update qlns_khenthuongkl set
	qlns_hinhthuc= \"$hinhthuc\",
    qlns_lydo= \"$lydo\",qlns_sotien=\"$sotien\",qlns_ghichu = \"$ghichu\"
	where qlns_idktkl = \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
	exit;
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Khen Thưởng Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<?php  
	$sql=@mysql_query("SELECT * FROM `qlns_khenthuongkl` ORDER BY qlns_idktkl desc") 
                   or die(mysql_error());
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"khenthuongkl.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('khenthuongkl.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_khenthuongkl where qlns_idktkl ='$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("khenthuongkl.php?dialoose=select");
