...
function pb_display(x,y)       
   {
   ajaxLoad('displaymanv.php?lich='+x,'lichps');
   }
</script>
<center>
<form action="lylichnvctn.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Tìm nhân viên theo Mã</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<?php $a="select * from qlns_hosonhanvien where qlns_tinhtrangnv != 2";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><option value='<?=$row['qlns_mahsnv']?>'><?php echo $row['qlns_manv']; ?></option>
<? }?> 
</select></td>
    	</tr>
   <tr><td><div id="lichps">
