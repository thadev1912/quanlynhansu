...
<script language="javascript">
	...
	{ var the_title    = the_form.title.value;
      if ((the_title==''))
		{
			alert("Ban Nhập thông tin gia đình !");
...
<form action="giadinhnv.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Gia Đình nhân viên </b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Gia Đình Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<tr><td colspan='3' height='20'></td></tr>
    	...
    	<tr> 
      	<td><font size="2"><b>Giới tính :</b></font><br>
        <select name="gioitinh" id="gioitinh" size=0>
	 <?php 
                 ...
                 <?php } else { ?>
                 		  <option value="<?php echo $c['qlns_gioitinh']; ?>">Nữ</option>
                          <option value="Nam">Nam</option>
                 	<?php }
    ...
    ?>	  
	 ...
	 <?php 
		         ...
		         if($c['qlns_tinhtrang']=="Còn Sống"){ ?>
                          <option value="<?php echo $c['qlns_tinhtrang']; ?>">Còn Sống</option>
                          <option value="Đã mất">Đã mất</option>
                 <?php } else { ?>
                 		  <option value="<?php echo $c['qlns_tinhtrang']; ?>">Đã mất</option>
                          <option value="Còn Sống">Còn Sống</option>
                 	<?php }
