...
if ( $_GET["act"] == "do" ) { 
	...
	$vinh=$_REQUEST['title'];
	$sqlss=@mysql_query("select * from qlns_bophan where qlns_mabp='$vinh'");
    $tong=@mysql_num_rows($sqlss);
    if($tong){
        echo '<br><br><br><br><br><br><div align="center">
<meta http-equiv="REFRESH" content="2; url=bophanctn.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
	  ...
	  <p align="center">
		<b><font color=red>Báo Lỗi ! Mã Bộ phận này đã có trong cơ sở dữ liệu. Bạn chọn mã bộ phận khác</font></b><br>
		<br>
      <img src="images/loading1.gif" width="150" height="13" border="0"> 
      <br>
      <br>(<a href="bophanctn.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';
			exit;
...
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    $q3 = "Insert into qlns_bophan set
	qlns_mabp  = \"$madonvi\",
    qlns_tenbophan = \"$tencongty\",
    ctn_id = \"$member_id\"
    ";
...
<script language="javascript">
	...
	{ var the_title    = the_form.title.value;
      if ((the_title==''))
		{
			alert("Bạn Nhập Thông Tin Bộ Phận!");
...
<center>
<form action="bophanctn.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm bộ phận công ty cổ phần đầu tư CTN Việt Nam</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
	...
	<TABLE  cellSpacing=2 cellPadding=2 width="95%" border=0>
    	...
    	<tr> 
      	<td><font size="2"><b>Mã bộ phân:</b></font><br>
        <input name="title" type="text" id="title" size="105" ></td>
    	</tr>
   <tr> 
      	<td ><font size="2"><b>Tên bộ phân:</b></font><br>
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_bophan where qlns_idbp= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=bophanctn.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"bophanctn.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $q3 = "update qlns_bophan set
	qlns_mabp  = \"$title\",
	qlns_tenbophan = \"$company_url\"
	where qlns_idbp = \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<TABLE  cellSpacing=2 cellPadding=2 width="95%" border=0>
        ...
        <input onkeyup=initTyper(this); name="title" type="text" id="title" value="<? echo $c['qlns_mabp']; ?>" size="136" ></td>
    	</tr>

    
      	<tr><td ><font size="2"><b>Tên bộ phận:</b></font><br>
	<textarea  name="content" cols="136" rows="10" id="content"><? echo $c['qlns_tenbophan']; ?></textarea><br>
	</td>
	</tr>
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <DIV align=center><B>Tên bộ phận</B></DIV></TD>
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_bophan` ORDER BY qlns_idbp DESC") 
                   or die(mysql_error());
			        while($row=@mysql_fetch_array($sql)) {
				$id=$row['qlns_idbp'];
				$title=$row['qlns_mabp'];
			    $company_url=$row['qlns_tenbophan'];
			    $qlns_mact=$row['qlns_mact'];
			    $sqldonvi=@mysql_query("select * from qlns_congty where qlns_mact='$qlns_mact' ");
			    $rowdv=@mysql_fetch_assoc($sqldonvi);
			    $tendonvi=$rowdv["qlns_tencongty"];
echo"
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"bophanctn.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('bophanctn.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
		}
?>
...
$q1 = "delete from qlns_bophan where qlns_idbp = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("bophanctn.php?dialoose=select");
