...
$root = "G:/SERVER/www/DATABASE NGUYEN GOC/STYLISH_V4.0";
#$root = "http://localhost/upload_iimag";
define( "_VALID_MOS", 1 );
$base_path = "../../..";
...
define("IMAGE_DIR", trim($root."/images/upload/"));
$url = "";// PATCH AJE:: Don't know what $url is doing????? this line is added
//$root = $url.$_SERVER['PHP_SELF']; 
$root = "/DATABASE NGUYEN GOC/STYLISH_V4.0/images/upload/";
$root = str_replace("/editor","",$root);
$root = str_replace("/htmlarea2","",$root);
$root = str_replace("/popups","",$root);
$root = str_replace("/viewer.php","/images/upload/",$root);
...
//   DocumentRoot of your webserver.
define("SCRIPT_DIR", trim($root."/editor/htmlarea2/popups/"));
$root = $url.$_SERVER['PHP_SELF'];
