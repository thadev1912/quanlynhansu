...
<script language="javascript">
	...
	{ var the_bophanmoi    = the_form.bophanmoi.value;
      if ((the_bophanmoi==''))
		{
			alert("Bạn nhập thông tin Luân chuyển/ Thăng tiến!");
...
<form action="thuyenchuyentt.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Luân Chuyển / Thăng Tiến Cán Bộ Nhân Viên </b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
   		<tr> 
      	<td><font size="2"><b>Bộ phận mới:</b></font><br>
...
<? }?> 
	<option value='55'>Công ty khác </option>
</select>
         </td>
    	</tr>
    		<tr> 
      	<td><font size="2"><b>Chức danh mới:</b></font><br>
        <input name="chucdanhmoi" type="text" id="chucdanhmoi" size="105" ></td>
    	</tr>
   		<tr> 
      	<td><font size="2"><b>Chức vụ mới:</b></font><br>
...
<? }?> 
        ...
        <tr> 
      	<td><font size="2"><b>Số Quyết định:</b></font><br>
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Sửa Luân Chuyển / Thăng Tiến Cán Bộ Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <DIV align=center><B>Bộ Phận mới</B></DIV></TD>
                                <TD class=textxanhbold12 width="25%">
                                <DIV align=center><B>Chức vụ mới</B></DIV></TD>
