...
<meta http-equiv="REFRESH" content="2; url=taisan.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="taisan.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_quanlytaisan set
...
function pb_display(x,y)       
   {
   ajaxLoad('displaytaisan.php?lich='+x,'lichps');
   }
</script>
<center>
<form action="taisan.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Tài sản được cán bộ nhân viên quản lý</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
   	 <tr> 
      	<td ><font size="2"><b>Tài sản:</b></font><br>
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_quanlytaisan where qlns_idts= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=taisan.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"taisan.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $q3 = "update qlns_quanlytaisan set
    qlns_taisan=\"$taisan\"	
	where qlns_idts = \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Tài sản được Cán bộ Nhân viên quản ly</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<tr><td colspan='3' height='20'></td></tr>
     ...
     <tr><td ><font size="2"><b>Tài sản:</b></font><br>
	<textarea  name="content" cols="136" rows="10" id="content"><? echo $c['qlns_taisan']; ?></textarea><br>
	</td>
	</tr>
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <TD class=textxanhbold12 width="35%">
                                 <DIV align=center><B>Tài sản</B></DIV></TD>
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_quanlytaisan` ORDER BY qlns_idts ASC") 
                   or die(mysql_error());
			     while($row=@mysql_fetch_array($sql)) {
				$id=$row['qlns_idts'];
				$qlns_mahsnv=$row['qlns_mahsnv'];
				$taisan=$row['qlns_taisan'];
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"taisan.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('taisan.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_quanlytaisan where qlns_idts = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("taisan.php?dialoose=select");
