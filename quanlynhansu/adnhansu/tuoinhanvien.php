...
function pb_display(x,y)       
   {
   ajaxLoad('displayctntuoinv.php?lich='+x,'lichps');
   }
</script>
<center>
...
<?php $a="select * from qlns_hosonhanvien group by qlns_tuoinv";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><option value='<?=$row['qlns_tuoinv']?>' <?php if($row['qlns_tinhthanhqq']=="Đà Nẵng") {echo "selected='select'"; } ?>><?php echo $row['qlns_tuoinv']; ?></option>
<? }?> ;
</select></td>
    	</tr>
   <tr><td><div id="lichps">
