...
if ($_GET["act"] == "do" ) { 
    ...
    $diachi= replace($_POST["gioithieu"]);
	  echo '<br><br><br><br><br><br><div align="center">
<meta http-equiv="REFRESH" content="2; url=dieuchuyennv.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="dieuchuyennv.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_dieuchuyennv set
	qlns_mahsnv  = \"$qlns_mahsnv\",
    qlns_dieuchuyennv = \"{$diachi}\"		
    ";
...
function pb_display(x,y)       
   {
   ajaxLoad('displaydieuchuyennv.php?lich='+x,'lichps');
   }
</script>
<center>
<form action="dieuchuyennv.php?act=do"  method="post" NAME="mainform" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm nghỉ việc của cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
   	 <tr> 
      	<td ><font size="2"><b>Nghỉ việc :</b></font><br>
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_dieuchuyennv where qlns_iddcnv= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=dieuchuyennv.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"dieuchuyennv.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $q3 = "update qlns_dieuchuyennv set
    qlns_dieuchuyennv=\"$taisan\"	
	where qlns_iddcnv = \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
	exit;
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Nghỉ việc</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<tr><td colspan='3' height='20'></td></tr>
     ...
     <tr><td ><font size="2"><b>Nghỉ việc:</b></font><br>
	<textarea  name="content" cols="136" rows="10" id="content"><? echo $c['qlns_dieuchuyennv']; ?></textarea><br>
	</td>
	</tr>
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <TD class=textxanhbold12 width="35%">
                                 <DIV align=center><B>Nghỉ việc</B></DIV></TD>
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_dieuchuyennv` ORDER BY qlns_iddcnv ASC") 
                   or die(mysql_error());
			     while($row=@mysql_fetch_array($sql)) {
				$id=$row['qlns_iddcnv'];
				$qlns_mahsnv=$row['qlns_mahsnv'];
				$taisan=$row['qlns_dieuchuyennv'];
...
<TD align=middle alignt=middle><P class=textxam12>$taisan</P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"dieuchuyennv.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('dieuchuyennv.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_dieuchuyennv where qlns_iddcnv = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("dieuchuyennv.php?dialoose=select");
