...
<meta http-equiv="REFRESH" content="2; url=nghiviec.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="nghiviec.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';
	$nghiviec=@mysql_query("update qlns_hosonhanvien set qlns_tinhtrangnv='$tinhtrangnv' where qlns_mahsnv='$qlns_mahsnv'");	
    $q3 = "Insert into qlns_thoiviec set
	qlns_mahsnv=\"$qlns_mahsnv\",qlns_ngaynghiviec  = \"$ngaybatdau\",
    qlns_hinhthuc =\"{$hinhthuc}\",qlns_lydonghi = \"{$lydo}\",qlns_trocapthoiviec= \"{$trocap}\",ctn_id = \"{$member_id}\"	
    ";
...
<script language="javascript">
	...
	{ var the_from    = the_form.from.value;
      if ((the_from==''))
		{
			alert("Bạn nhập thông tin nghỉ việc cán bộ nhân viên!");
			the_form.from.focus();
			return false;
		}
}
...
<center>
<form action="nghiviec.php?act=do"  method="post" NAME="dk" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Nghỉ việc cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
   	 	...
   	 	<tr> 
      	<td ><font size="2"><b>Ngày nghỉ việc :</b></font>
<input  name="from" type="text" id="from" size='70' >
	...
	<textarea  name="lydo" cols="136" rows="10" id="lydo"></textarea><br>
		...
		<tr> 
       <td><font size="2"><b>Trợ cấp thôi việc :</b></font>
       <input  name="trocap" type="text" id="trocap" size='70'>
	</td>
	</tr> 		
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_thoiviec where qlns_idtv= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=nghiviec.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"nghiviec.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    $nghiviec=@mysql_query("update qlns_hosonhanvien set qlns_tinhtrangnv='$tinhtrangnv' where qlns_mahsnv='2'");	
    $ngaybatdau= $_POST["from"];
    $hinhthuc= $_POST["hinhthuc"];
    $trocap= $_POST["trocap"];
    $lydo= $_POST["lydo"];
    $q3 = "update qlns_thoiviec set
    qlns_ngaynghiviec=\"$ngaybatdau\",qlns_hinhthuc=\"$hinhthuc\",qlns_lydonghi =\"$lydo\",qlns_trocapthoiviec =\"$trocap\"	
	where qlns_idtv = \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
...
<form enctype="multipart/form-data" method="POST" NAME="dk"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Nghỉ việc Cán Bộ Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<tr><td colspan='3' height='20'></td></tr>
    ...
    <tr> 
      	<td ><font size="2"><b>Ngày Nghỉ việc :</b></font>
           <input  name="from" type="text" id="from" size='70' value="<?php echo $c['qlns_ngaynghiviec']; ?>" >
           <a href="javascript:show_calendar('dk.from');"><img src="images/calendar.jpg" width="16" height="15" border="0"></a><br>
	</td>
	</tr> 
		<tr> 
	...
	<textarea  name="lydo" cols="136" rows="10" id="lydo"><? echo $c['qlns_lydonghi']; ?></textarea><br>
	</td>
	</tr>
		<tr> 
       <td><font size="2"><b>Trợ cấp thôi việc :</b></font>
       <input  name="trocap" type="text" id="trocap" size='70' value="<?php echo $c['qlns_trocapthoiviec']; ?>">
	</td>
	</tr> 	
	<tr> 
...
<script language='javascript' type='text/javascript'>
    ...
    function baoloi(theURL) {
       if (confirm('Bạn có chắc là muốn xóa không vậy?')) {
          window.location.href=theURL;
       }
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <TD class=textxanhbold12 width="12%">
                                 ...
                                 <DIV align=center><B>Hình thức nghỉ</B></DIV></TD>
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_thoiviec` ORDER BY qlns_idtv desc") 
                   or die(mysql_error());
			     while($row=@mysql_fetch_array($sql)) {
				$id=$row['qlns_idtv'];
				$qlns_mahsnv=$row['qlns_mahsnv'];
				$qlns_ngaybd=$row['qlns_ngaynghiviec'];
				$qlns_ngaykt=$row['qlns_hinhthuc'];
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"nghiviec.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('nghiviec.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_thoiviec where qlns_idtv = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("nghiviec.php?dialoose=select");
