...
if ($_GET["act"] == "do" ) { 
    ...
    $dotdanhgia= intval($_POST["dotdanhgia"]);
    $ngaydanhgia=$_POST["from"];  
    $xeploai=$_POST["xeploai"]; 
    $nhanxet=$_POST["nhanxet"];   	
    	echo '<br><br><br><br><br><br><div align="center">
<meta http-equiv="REFRESH" content="2; url=trinhdonv.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="trinhdonv.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_danhgianv set
	qlns_mahsnv  = \"$qlns_mahsnv\",
    qlns_dotdanhgia = \"{$qlns_dotdanhgia}\",qlns_xeploai = \"{$xeploai}\",qlns_nhanxet = \"{$nhanxet}\",qlns_ngaydanhgia= \"{$ngaydanhgia}\"		
    ";
...
function pb_display(x,y)       
   {
   ajaxLoad('displaytrinhdonv.php?lich='+x,'lichps');
   }
</script>
<center>
<form action="trinhdonv.php?act=do"  method="post"  onsubmit="return check_form(this)" NAME="dk">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Đánh giá cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
   	  <tr> 
      	<td ><font size="2"><b>Đợt Đánh Giá :</b></font>
	<select name="dotdanhgia" id="dotdanhgia" size=0>
<option value="1">Đánh giá giữa năm </option>
<option value="0">Đánh giá cuối năm </option>
</select><br>
	</td>
	</tr> 
	<tr> 
      	<td ><font size="2"><b>Ngày Đánh Giá :</b></font>
<input  name="from" type="text" id="from" size='70' >
	...
	<tr> 
      	<td ><font size="2"><b>Xếp Loại :</b></font>
	<select name="xeploai" id="xeploai" size=0>
...
<option value="2">C</option>		
   	 ...
   	 <tr> 
      	<td ><font size="2"><b>Nhận xét :</b></font><br>
	<textarea  name="nhanxet" cols="136" rows="10" id="nhanxet"></textarea><br>
	</td>
	</tr> 
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_danhgianv where qlns_madg= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=trinhdonv.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"trinhdonv.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $xeploai=$_POST["xeploai"]; 
    $nhanxet=$_POST["nhanxet"];   
    $q3 = "update qlns_danhgianv set
    qlns_dotdanhgia=\"$dotdanhgia\",qlns_xeploai=\"$xeploai\",qlns_nhanxet=\"$nhanxet\",qlns_ngaydanhgia=\"$ngaydanhgia\"	
	where qlns_madg= \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
...
<form enctype="multipart/form-data" method="POST" NAME="dk"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Đánh giá Cán bộ Nhân viên </b></font></div></td>
    	</tr>
	</TBODY></TABLE>
	...
	<TABLE  cellSpacing=2 cellPadding=2 width="95%" border=0>
       ...
       <tr><td>
     <?php  	$query=@mysql_query("SELECT * FROM qlns_hosonhanvien WHERE qlns_mahsnv='$manv'");
...
<tr><td colspan='3' height='20'></td></tr>
      ...
      <tr>
        <td align="left" class="style1"><B>Đợt đánh giá: 
           <select name="dotdanhgia" id="dotdanhgia" size=0>
	 <?php 

		     $vinh=$c['qlns_dotdanhgia'];
		         if($vinh==1){ ?>
                          <option value="<?php echo $c['qlns_dotdanhgia']; ?>">Đánh giá giữa năm</option>
                          <option value="0">Đánh giá cuối năm</option>
                 <?php } else { ?>
                 		  <option value="<?php echo $c['qlns_dotdanhgia']; ?>">Đánh giá cuối năm</option>
                          <option value="1">Đánh giá giữa năm</option>
                 	<?php }
    ...
    ?>	  
      ...
      <tr>
        <td align="left" class="style1"><B>Ngày đánh giá :<input  name="from" type="text" id="from" size='70' value="<?php echo $c['qlns_ngaydanhgia']; ?>" >
          <a href="javascript:show_calendar('dk.from');"><img src="images/calendar.jpg" width="16" height="15" border="0"></a></td>
      </tr>	
       <tr>
        <td align="left" class="style1"><B>Xếp loại :
      <select name="xeploai" id="xeploai" size=0>
	 <?php 

		     $vinh12=$c['qlns_xeploai'];
		         if($vinh12==1){ ?>
                          <option value="<?php echo $c['qlns_xeploai']; ?>">A</option>
                          <option value="0">B</option>
                          <option value="2">C</option>
                   <?php } 
                 if($vinh12==2){ ?>
                          <option value="<?php echo $c['qlns_xeploai']; ?>">C</option>
                          <option value="0">B</option>
                          <option value="1">A</option>       	  	  
                 <?php } else { ?>
                 		  <option value="<?php echo $c['qlns_xeploai']; ?>">B</option>
    ...
    ?>	  
     ...
     <tr><td ><font size="2"><b>Nhận xét :</b></font><br>
	<textarea  name="nhanxet" cols="136" rows="10" id="nhanxet"><? echo $c['qlns_nhanxet']; ?></textarea><br>
	</td>
	</tr>
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <TD class=textxanhbold12 width="35%">
                                 <DIV align=center><B>Xếp Loại</B></DIV></TD>
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_danhgianv` ORDER BY qlns_madg desc") 
                   or die(mysql_error());
			     while($row=@mysql_fetch_array($sql)) {
				$id=$row['qlns_madg'];
			    
				$qlns_mahsnv=$row['qlns_mahsnv'];
				$xeploai=$row['qlns_xeploai'];
...
<TD align=middle alignt=middle><P class=textxam12><div align='center'>"; if($xeploai==1){echo "A"; }elseif($xeploai==0){echo "B"; } else {echo "C"; } 
	echo "</P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"trinhdonv.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('trinhdonv.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_danhgianv where qlns_madg = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("trinhdonv.php?dialoose=select");
