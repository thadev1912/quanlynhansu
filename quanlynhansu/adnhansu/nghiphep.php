...
<meta http-equiv="REFRESH" content="2; url=nghiphep.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="nghiphep.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_nghiphep set
	qlns_mahsnv=\"$qlns_mahsnv\",qlns_ngaybd  = \"$ngaybatdau\",
    qlns_ngaykt =\"{$ngayketthuc}\",qlns_songaynghi=\"{$songaynghi}\",qlns_lydonghi = \"{$lydo}\"	
    ";
...
<script language="javascript">
	...
	{ var the_from    = the_form.from.value;
      if ((the_from==''))
		{
			alert("Bạn nhập thông tin nghỉ phép cán bộ nhân viên!");
			the_form.from.focus();
			return false;
		}
}
...
<center>
<form action="nghiphep.php?act=do"  method="post" NAME="dk" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Nghỉ phép cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<input  name="end" type="text" id="end" size='70' >
		...
		<tr> 
      	<td ><font size="2"><b>Số ngày nghỉ :</b></font>
<input  name="songaynghi" type="text" id="songaynghi" size='70' >
         <br>
	</td>
	</tr> 
	<tr> 
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_nghiphep where qlns_idnp= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=nghiphep.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"nghiphep.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $lydo= $_POST["lydo"];
    $songaynghi= $_POST["songaynghi"];
    $q3 = "update qlns_nghiphep set
    qlns_ngaybd=\"$ngaybatdau\",qlns_ngaykt=\"$ngayketthuc\",qlns_songaynghi=\"{$songaynghi}\",qlns_lydonghi =\"$lydo\"	
	where qlns_idnp= \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
...
<form enctype="multipart/form-data" method="POST" NAME="dk"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Nghỉ phép Cán Bộ Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<input  name="end" type="text" id="end" size='70' value="<?php echo $c['qlns_ngaykt']; ?>" >
    ...
    <tr> 
      	<td ><font size="2"><b>Số ngày nghỉ :</b></font>
<input  name="songaynghi" type="text" id="songaynghi" size='70' value="<?php echo $c['qlns_songaynghi']; ?>" >
         <br>
	</td>
	</tr> 		
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_nghiphep` ORDER BY qlns_idnp desc") 
                   or die(mysql_error());
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"nghiphep.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('nghiphep.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_nghiphep where qlns_idnp = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("nghiphep.php?dialoose=select");
