...
<meta http-equiv="REFRESH" content="2; url=xephangnv.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="xephangnv.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_capbac set
	qlns_mahsnv=\"$qlns_mahsnv\",qlns_xephang= \"$xephang\",qlns_ngayhieuluc  = \"$ngaybatdau\",
    qlns_ngayhethieuluc =\"{$ngayketthuc}\",qlns_soquyetdinh= \"$soquyetdinh\",qlns_ghichu= \"$ghichu\"
    ";
...
<script language="javascript">
	...
	{ var the_from    = the_form.from.value;
      if ((the_from==''))
		{
			alert("Bạn nhập thông tin xếp hạng cán bộ nhân viên!");
			the_form.from.focus();
			return false;
		}
}
...
<center>
<form action="xephangnv.php?act=do"  method="post" NAME="dk" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Xếp Hạng cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
    	<tr> 
      	<td ><font size="2"><b>Xếp Hạng  :</b></font>
<input  name="xephang" type="text" id="xephang" size='70' >
	</td>
	</tr> 	
   	 	<tr> 
...
<input  name="end" type="text" id="end" size='70' >
		...
		<tr> 
      	<td ><font size="2"><b>Số quyết định  :</b></font>
<input  name="soquyetdinh" type="text" id="soquyetdinh" size='70' >
	</td>
	</tr> 		
	<tr> 
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_capbac where qlns_idcb= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=xephangnv.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"xephangnv.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    $xephang= $_POST["xephang"];
    ...
    $soquyetdinh= $_POST["soquyetdinh"];
    $ghichu= $_POST["ghichu"];
    $q3 = "update qlns_capbac set
    qlns_xephang=\"$xephang\",qlns_ngayhieuluc=\"$ngaybatdau\",qlns_ngayhethieuluc=\"$ngayketthuc\"	,qlns_soquyetdinh=\"$soquyetdinh\",qlns_ghichu=\"$ghichu\"
	where qlns_idcb= \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
...
<form enctype="multipart/form-data" method="POST" NAME="dk"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Xếp Hạng Cán Bộ Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<tr><td colspan='3' height='20'></td></tr>
     		...
     		<tr> 
      	<td ><font size="2"><b>Xếp Hạng :</b></font>
<input  name="xephang" type="text" id="xephang" size='70'  value="<?php echo $c['qlns_xephang']; ?>">
	</td>
	</tr> 				
    <tr> 
      	<td ><font size="2"><b>Ngày Hiệu Lực :</b></font>
...
<input  name="end" type="text" id="end" size='70' value="<?php echo $c['qlns_ngayhethieuluc']; ?>" >
    	...
    	<tr> 
      	<td ><font size="2"><b>Số Quyết Định :</b></font>
<input  name="soquyetdinh" type="text" id="soquyetdinh" size='70'  value="<?php echo $c['qlns_soquyetdinh']; ?>">
	</td>
	</tr> 	
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_capbac` ORDER BY qlns_idcb desc") 
                   or die(mysql_error());
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"xephangnv.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('xephangnv.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
redirect("xephangnv.php?dialoose=select");
