...
<tr> 
    ...
    <textarea  name="noidung" style="width:70%;height:250px;"  id="noidung"></textarea></td></td>
	 ...
	 <tr> 
      <td><font size="2"><b>Đường dẫn:</b></font><br>
...
<div id="tipDiv" style="Z-INDEX:1; VISIBILITY:hidden; POSITION:absolute"></div>
 ...
 <table width="96%" border="0" cellspacing="0" cellpadding="2" >
  <tr>
   <td colspan=2 bgcolor="#4B9BE0"><img src="images/newsmodule.gif" width="21" height="20"  alt='Liệt kê tin tức | Select news'/><b><font color="#FFFFFF" size=2> DANH SÁCH TIN TỨC </td></tr><tr><td colspan=1 bgcolor="#4B9BE0" width=70%><div align='right'><form action="cableentertainment.php?dialoose=selectcat1" method='POST' name=hi><select name="theloai" id="theloai">
<?php 
$a="select * from ctn_catentertainment";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
...
<? }?>     <input  name="submit" type="submit" id="submit" value="Tìm"></form></td></select>
  ...
  <tr height=20>
      ...
      <tr onmouseover="this.bgColor='#CCCCCC'" onmouseout="this.bgColor='#FFFFFF'" bgColor=#ffffff>
        ...
        <td align="center" class=textxam12><A  href="cableentertainment.php?dialoose=edit&id=<?php echo $row['enter_id'];?>" onmouseover="showtip('<?php if($vinh==1)echo ' <b>Bài viết đã được duyệt</b><br>Bạn click vào đây để xem chi tiết'; else echo 'Bạn click vào đây để xem chi tiết<br> Sửa và duyệt bài viết'; ?>')" 
        ...
        <td align="center" class=textxam12><a class='Market' ><?php echo $row['enter_datec'];?> </a></td>
         <td align="center" class=textxam12><a class='Market' href='#' onmouseover='doTooltip(event,"../images/entertainment/<?php echo $row['enter_images'];?>","<div align=center> Ảnh minh họa chi tiết  cho bài viết")' onmouseout='hideTip()'><?php echo $row['enter_images'];?> </a></td>
          <td width="7%" class=textxam12><div align="center"><a href="cableentertainment.php?dialoose=edit&id=<?php echo $row['enter_id'];?>"><img src='images/icon_duyetbai.gif' width='16' height='16' border='0' alt='Chỉnh sửa tin tức | Change news'> </a></div></td>
        <td width="6%" class=textxam12><div align="center"><a href="javascript:baoloi('cableentertainment.php?dialoose=remove3&id=<?php echo $row['enter_id'];?>')"><img src='images/drop.jpg' width='16' height='16' border='0' alt='Xoá tin tức  | Delete news'> </a></div></td>
      </tr>
      <?php }
      $i++;
      if($i>=$page_end){
...
<? }?>     <input  name="submit" type="submit" id="submit" value="Tìm"></form></td></select>
  ...
  <tr height=20>
      ...
      <tr onmouseover="this.bgColor='#CCCCCC'" onmouseout="this.bgColor='#FFFFFF'" bgColor=#ffffff>
        ...
        <td align="center" class=textxam12><a class='Market'><?php echo $row['enter_datec'];?> </a></td>
        <td align="center" class=textxam12><a class='Market' href='#' onmouseover='doTooltip(event,"../images/entertainment/<?php echo $row['enter_images'];?>","<div align=center> Ảnh minh họa cho bài viết")' onmouseout='hideTip()'><?php echo $row['enter_images'];?> </a></td>
        <td width="7%" class=textxam12><div align="center"><a href="cableentertainment.php?dialoose=edit&id=<?php echo $row['enter_id'];?>"><img src='images/icon_duyetbai.gif' width='16' height='16' border='0' alt='Chỉnh sửa tin tức | Change news'> </a></div></td>
        <td width="6%" class=textxam12><div align="center"><a href="javascript:baoloi('cableentertainment.php?dialoose=remove3&id=<?php echo $row['enter_id'];?>')"><img src='images/drop.jpg' width='16' height='16' border='0' alt='Xoá tin tức  | Delete news'> </a></div></td>
      </tr>
      <?php }
...
echo "<br><br><center>Hi&#7879;n c&#243; <b>".@mysql_num_rows($count_query)."</b> th&#7875; lo&#7841;i giải trí trong c&#417; s&#7903; d&#7919; li&#7879;u.<br><br>
