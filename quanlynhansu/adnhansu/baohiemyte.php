...
<meta http-equiv="REFRESH" content="2; url=baohiemyte.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="baohiemyte.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';	
    $q3 = "Insert into qlns_baohiemyte set
	qlns_mahsnv=\"$qlns_mahsnv\",qlns_tungayyt  = \"$ngaybatdau\",
    qlns_toingayyt = \"{$ngayketthuc}\",qlns_luongbh = \"{$luongbaohiem}\",qlns_canhan= \"{$canhan}\",
    qlns_congty = \"{$congty}\",qlns_sothebhyt=\"{$sothebaohiem}\",qlns_noikcb=\"{$noikcb}\",qlns_ghichu = \"{$ghichu}\"	
    ";
...
<center>
<form action="baohiemyte.php?act=do"  method="post" NAME="dk" onsubmit="return check_form(this)">

	<TABLE  cellSpacing=1 cellPadding=0 width="95%" border=0>
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Bảo hiểm y tế cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<? }?> 
 ...
 <div></td></tr>
    	<tr> 
      	<td ><font size="2"><b>Số thẻ BHYT  :</b></font>
...
<input  name="canhan" type="text" id="canhan" size='70' >
   	...
   	<tr> 
        ...
        <input  name="congty" type="text" id="congty" size='70' >
   		...
   		<tr> 
      	<td ><font size="2"><b>Nơi khám chữa bệnh :</b></font>
         <select name="noikcb" id="noikcb" size=0>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
<option value="Bệnh viện Quận 1">Bệnh viện Quận 1 </option>
<option value="Bệnh viện Quận 2">Bệnh viện Quận 2 </option>
<option value="Bệnh viện Liên Chiểu">Bệnh viện Liên Chiểu </option>
<option value="Bệnh viện Ngũ Hành Sơn">Bệnh viện Ngũ Hành Sơn </option>
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																			   
</select>
	</td>
	</tr> 
	<tr> 
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from qlns_baohiemyte where qlns_idbhyt= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=baohiemyte.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"baohiemyte.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
    ...
    $noikcb= $_POST["noikcb"];
    $ghichu= $_POST["ghichu"];
    $q3 = "update qlns_baohiemyte set
    qlns_tungayyt=\"$ngaybatdau\",qlns_toingayyt=\"$ngayketthuc\",qlns_luongbh=\"$luongbaohiem\",qlns_canhan =\"$canhan\",qlns_congty =\"$congty\",qlns_sothebhyt =\"$sothebaohiem\",qlns_noikcb =\"$noikcb\",qlns_ghichu =\"$ghichu\"	
	where qlns_idbhyt= \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
	exit;
...
<form enctype="multipart/form-data" method="POST" NAME="dk"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Bảo Hiểm Y Tế Cán Bộ Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<tr><td colspan='3' height='20'></td></tr>
     	...
     	<tr> 
      	<td ><font size="2"><b>Số Thẻ BHYT :</b></font>
<input  name="sothebaohiem" type="text" id="sothebaohiem" size='70' value="<?php echo $c['qlns_sothebhyt']; ?>">
	</td>
	</tr>   			
      <tr> 
      	<td ><font size="2"><b>Lương đóng bảo hiểm :</b></font>
<input  name="luongbaohiem" type="text" id="luongbaohiem" size='70' value="<?php echo $c['qlns_luongbh']; ?>">
	</td>
	</tr>    			
    <tr> 
      	<td ><font size="2"><b>Ngày Bắt đầu :</b></font>
<input  name="from" type="text" id="from" size='70' value="<?php echo $c['qlns_tungayyt']; ?>" >
          <a href="javascript:show_calendar('dk.from');"><img src="images/calendar.jpg" width="16" height="15" border="0"></a><br>
	</td>
	</tr> 
	<tr> 
      	<td ><font size="2"><b>Ngày Kết thúc :</b></font>
<input  name="end" type="text" id="end" size='70' value="<?php echo $c['qlns_toingayyt']; ?>" >
          <a href="javascript:show_calendar('dk.end');"><img src="images/calendar.jpg" width="16" height="15" border="0"></a><br>
	</td>
	</tr> 			
    	<tr> 
      	<td ><font size="2"><b>Cá nhân đóng :</b></font>
<input  name="canhan" type="text" id="canhan" size='70' value="<?php echo $c['qlns_canhan']; ?>">
	</td>
	</tr>   
		<tr> 
      	<td ><font size="2"><b>Công ty đóng :</b></font>
<input  name="congty" type="text" id="congty" size='70' value="<?php echo $c['qlns_congty']; ?>">
	</td>
	</tr>   			
		...
		<tr> 
      	<td ><font size="2"><b>Nơi khám chữa bệnh :</b></font>
         <select name="noikcb" id="noikcb" size=0>
            <?php if($c['qlns_noikcb']=="Bệnh viện Đa Khoa"){ ?>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
<option value="Bệnh viện Quận 1">Bệnh viện Quận 1 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện Hoàn Mỹ"){ ?>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
<option value="Bệnh viện Quận 1">Bệnh viện Quận 1 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện C17"){ ?>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện Quận 1">Bệnh viện Quận 1 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện Quận 1"){ ?>
<option value="Bệnh viện Quận 1">Bệnh viện Quận 1 </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện Quận 2"){ ?>
<option value="Bệnh viện Quận 2">Bệnh viện Quận 2 </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện Liên Chiểu"){ ?>
<option value="Bệnh viện Liên Chiểu">Bệnh viện Liên Chiểu </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện Ngũ Hành Sơn"){ ?>
<option value="Bệnh viện Ngũ Hành Sơn">Bệnh viện Ngũ Hành Sơn </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
...
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																		   
       <?php } elseif($c['qlns_noikcb']=="Bệnh viện Sơn Trà"){ ?>
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
<option value="Bệnh viện C17">Bệnh viện C17 </option>
...
<option value="Bệnh viện Ngũ Hành Sơn">Bệnh viện Ngũ Hành Sơn </option>	
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>		
	 <?php } elseif($c['qlns_noikcb']=="Bệnh viện Quân Y 17"){ ?>
<option value="Bệnh viện Quân Y 17">Bệnh viện Quân Y 17 </option>																			   
<option value="Bệnh viện Sơn Trà">Bệnh viện Sơn Trà </option>
<option value="Bệnh viện Hoàn Mỹ">Bệnh viện Hoàn Mỹ</option>
<option value="Bệnh viện Đa Khoa">Bệnh viện Đa Khoa</option>
...
<div align=center> <TABLE class=MenuTop cellSpacing=1 borderColor=#111111 cellSpacing=0 cellPadding=0  bgcolor=#000000 cellPadding=1 width="90%" border=0>
                                ...
                                <TD class=textxanhbold12 width="15%">
                                 <DIV align=center><B>Số thẻ BHYT</B></DIV></TD>
...
<?
$sql=@mysql_query("SELECT * FROM `qlns_baohiemyte` ORDER BY qlns_idbhyt desc") 
                   or die(mysql_error());
			     while($row=@mysql_fetch_array($sql)) {
				$id=$row['qlns_idbhyt'];
				$qlns_mahsnv=$row['qlns_mahsnv'];
				$qlns_sothebhyt=$row['qlns_sothebhyt'];
				$qlns_ngaybd=$row['qlns_tungayyt'];
				$qlns_ngaykt=$row['qlns_toingayyt'];
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"baohiemyte.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('baohiemyte.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from qlns_baohiemyte where qlns_idbhyt = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

redirect("baohiemyte.php?dialoose=select");
