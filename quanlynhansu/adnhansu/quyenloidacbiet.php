...
<script language="javascript">
	...
	{ var the_from    = the_form.from.value;
      if ((the_from==''))
		{
			alert("Bạn nhập thông tin quyền lợi đặc biệt cán bộ nhân viên!");
			the_form.from.focus();
			return false;
		}
}
...
<form action="quyenloidacbiet.php?act=do"  method="post" NAME="dk" onsubmit="return check_form(this)">
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>Thêm Quyền lợi đặc biệt cán bộ nhân viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<input  name="end" type="text" id="end" size='70' >
   ...
   <input  name="tiente" type="text" id="tiente" size='70' >
	...
	<tr> 
      	<td ><font size="2"><b>Loại quyền lợi :</b></font><br>
...
<form enctype="multipart/form-data" method="POST" NAME="dk"> 
	...
	<tr> 
      	<td colspan="1"> 
        <div align="center"><font face=Tahoma size="2" color="#0000FF"><b>S&#7917;a Quyền Lợi đặc biệt Cán Bộ Nhân Viên</b></font></div></td>
    	</tr>
	</TBODY></TABLE>
...
<input  name="tiente" type="text" id="tiente" size='70' value="<?php echo $c['qlns_sotien']; ?>">
    ...
    <tr><td ><font size="2"><b>Loại Quyền lợi :</b></font><br>
